...
{
    public record CreateAccessRequestCommand(AccessType RequestedAccess) : IRequest<AccessRequest>;
    public record ReviewAccessRequestCommand(int RequestId, bool Approve, int AdminId) : IRequest<Unit>;
}
